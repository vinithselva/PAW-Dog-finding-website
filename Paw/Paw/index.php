...
<header class="py-4">
	<div class="container">
			<div id="logo">
				<h1> <a href="index.html"><span class="fa fa-paw" aria-hidden="true"></span> Paw</a></h1>
			</div>
		<!-- nav -->
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				...
				<li class=""><a href="team.php">Breeds</a></li>
        <li><a class="user" href="#popup3"> Contact Us</a></li>

			</ul>
			<div class="login-icon ml-lg-2">
        <li class=""><?php  if (isset($_SESSION['email'])) : ?>
        <p style="color: white;">Welcome <strong><?php echo $_SESSION['username']; ?></strong>
  		</br><a href="index.php?logout='1'" style="color: blue;">logout</a> </p>
      <?php else: ?>
          <a href="login.php">LOGIN</a><?php endif ?></li>
			</div>
		</nav>
		<div class="clear"></div>
		<!-- //nav -->
	...
	<div class="container">
		<div class="row banner-text">
			<div class="slider-info col-lg-6">
				...
				<a class="btn mr-2 text-capitalize" href="map.php">Open Search </a>
				<a class="btn text-capitalize" href="dog_register.php">Breed Search </a>
			</div>
...
<div class="copy-right-top border-top">
	<p class="copy-right text-center py-4">&copy; 2019 Paw. All Rights Reserved | Design by
		<a href="http://w3layouts.com/"> Paw </a>
	</p>
</div>
<!-- //copyright -->
